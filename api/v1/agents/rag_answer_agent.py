...
def run_rag_agent(
    ...
    # ... [keep everything above this in run_rag_agent] ...
    ...
    # 1. SQL Path: Answer is raw text stored directly in synthesized_answer
    if final_state.get("route") == "sql" and final_state.get("synthesized_answer"):
        answer = final_state["synthesized_answer"]
        
    # 2. Document/Hybrid Paths: Answer is JSON inside the last AIMessage
    else:
        for msg in reversed(messages):
    ...
    # ... [keep everything below this in run_rag_agent] ...
